...
public class LeagueController implements Initializable {
                ...
                if(mouseEvent.getButton().equals(MouseButton.PRIMARY)){
                    if(mouseEvent.getClickCount() == 2){
                        try {
                            ...
                            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Arena/Client/FXML/TournamentLobby.fxml"));
    ...
    private void btnCreateLeague(ActionEvent event) throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("/Arena/Client/FXML/CreateLeague.fxml"));
        Stage stage = new Stage();
    ...
    private void btnCreateTournament(ActionEvent event) throws IOException {
        ((Node) (event.getSource())).requestFocus();
        Parent parent = FXMLLoader.load(getClass().getResource("/Arena/Client/FXML/CreateTournament.fxml"));
        Stage stage = new Stage();
        Scene scene = new Scene(parent);
        stage.setScene(scene);
