...
public class MainController implements Initializable {
    ...
    private void btnAccount(ActionEvent event) throws IOException, SQLException {
        ...
        Parent node = FXMLLoader.load(getClass().getResource("/Client/FXML/Account.fxml"));
    ...
    private void btnLibrary(ActionEvent event) throws IOException {
        ((Node) (event.getSource())).requestFocus();
        Parent node = FXMLLoader.load(getClass().getResource("/Client/FXML/Library.fxml"));
        pane.getChildren().clear();
        pane.getChildren().add(node);
    }
    @FXML
    private void btnLeague(ActionEvent event) throws IOException {
        ((Node) (event.getSource())).requestFocus();
        Parent node = FXMLLoader.load(getClass().getResource("/Client/FXML/League.fxml"));
        pane.getChildren().clear();
        pane.getChildren().add(node);
    }
    @FXML
    private void btnView(ActionEvent event) throws IOException {
        ((Node) (event.getSource())).requestFocus();
        Parent node = FXMLLoader.load(getClass().getResource("/Client/FXML/View.fxml"));
        pane.getChildren().clear();
        pane.getChildren().add(node);
    }
    @FXML
    private void btnAds(ActionEvent event) throws IOException {
        ((Node) (event.getSource())).requestFocus();
        Parent node = FXMLLoader.load(getClass().getResource("/Client/FXML/Ads.fxml"));
        pane.getChildren().clear();
        pane.getChildren().add(node);
    }
    @FXML
    public void CloseApp(ActionEvent event) throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("/Client/Login/LoginDialogPane.fxml"));
